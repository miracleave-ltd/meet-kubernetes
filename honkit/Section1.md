...
これにより、陸海一貫輸送ができるようになった

<br>

#### これをIT業界に例えると
##### コンテナ以前
オンプレやクラウドを使ってそれぞれの環境を作成する

システム管理者による環境維持、バッチ適用、セキュリティ、不具合修正、負荷増対応など
...
##### コンテナの今
コンテナをパイプラインのように流すことができる

開発環境にあったものは検証環境や本番環境にそのまま流すことができる
